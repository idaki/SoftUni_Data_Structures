...
public class RedBlackTree<Key extends Comparable<Key>, Value> {
    ...
    public Value get(Key key) {
        ...
        if (key == null) {
            throw new IllegalStateException("key cannot be null in get() call");
        }
    ...
    public void put(Key key, Value val) {
        if (key == null) {
            throw new IllegalStateException("key cannot be null in put() call");
        }
    ...
    public void delete(Key key) {
        if (key == null || isEmpty()) {
            throw new IllegalStateException("Delete call with illegal state");
        }
        if (!contains(key)) {
            return;
    ...
    private Node rotateRight(Node h) {
        Node temp = h.left;
        h.left = temp.right;//todo could be h not temp
        temp.right = h;
